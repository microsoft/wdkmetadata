...
typedef struct _CO_TAPI_TRANSLATE_TAPI_CALLPARAMS
{
    _In_  ULONG                 ulLineID;
    _In_  ULONG                 ulAddressID;
    _In_  ULONG                 ulFlags;         // see below
    _In_  NDIS_VAR_DATA_DESC    DestAddress;
    _In_  NDIS_VAR_DATA_DESC    LineCallParams;  // LINE_CALL_PARAMS
    _Out_ NDIS_VAR_DATA_DESC    NdisCallParams;  // CO_CALL_PARAMETERS
...
{
    _In_  ULONG                 ulFlags;         // see above
    _In_  NDIS_VAR_DATA_DESC    NdisCallParams;  // CO_CALL_PARAMETERS
    _Out_ NDIS_VAR_DATA_DESC    LineCallInfo;    // LINE_CALL_INFO
...
typedef struct _CO_TAPI_TRANSLATE_SAP
{
    ...
    _Out_ NDIS_VAR_DATA_DESC    NdisSapParams[1];   // CO_SAP
...
typedef struct _CO_AF_TAPI_MAKE_CALL_PARAMETERS
{
    _In_  ULONG                 ulLineID;
    _In_  ULONG                 ulAddressID;
    _In_  ULONG                 ulFlags;         // see CO_TAPI_TRANSLATE_TAPI_CALLPARAMS
    _In_  NDIS_VAR_DATA_DESC    DestAddress;
    _In_  NDIS_VAR_DATA_DESC    LineCallParams;  // LINE_CALL_PARAMS
...
typedef struct _CO_AF_TAPI_INCOMING_CALL_PARAMETERS
{
    ...
    _In_  ULONG                 ulAddressID;
    _In_  ULONG                 ulFlags;         // see CO_TAPI_TRANSLATE_TAPI_CALLPARAMS
    _In_  NDIS_VAR_DATA_DESC    LineCallInfo;    // LINE_CALL_INFO
