...
#pragma warning(push)
#pragma warning(disable:4201)   // Nameless union / struct when compiled for C/CPP.
...
#ifndef __cplusplus
#pragma warning(push)
#pragma warning(disable:4115)   // Named type definition in parentheses when compiled for C
#endif 
